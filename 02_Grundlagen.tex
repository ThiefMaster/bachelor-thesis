...
Im \emph{HEAD}-Abschnitt des Dokuments finden sich neben dem Seitentitel und Metadaten verschiedene
...
\todotext{DOM-Referenz in den Anhang}
...
\subsection{Browserspezifische Unterschiede}
