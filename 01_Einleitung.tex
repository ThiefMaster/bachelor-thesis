...
Die Abteilung \em{IT-UDS-AVC}\footnote{User and Document Services - Audio Visual \& Conference
...
den Status des \em{LHC}\footnote{\em{Large Hadron Collider}, der Teilchenbeschleuniger am CERN} und
...
Beiträgen sein. Die Applikation unterstützt außerdem externe Benutzerauthentifizierung, \em{Paper
Reviewing}\footnote{Im Rahmen eines \em{Call for Papers} oder \em{Call for Abstracts} bei einer
...
\href{http://maps.google.com/}{\em{Google Maps}}-basierten Karte anzeigen zu lassen und
