...
handelt - als Dokumentation sind diese nicht brauchbar, was dank der Onlinedokumentation aber auch
nicht notwendig ist.
...
\item[Dokumentation] \hfill \\
Classy besitzt eine Onlinedokumentation, in der die Benutzung anhand von Beispielen beschrieben wird
...
den Konstruktor einer Parentklasse mittels \lstinline{this.NameOfTheClass()} aufruft, nicht
