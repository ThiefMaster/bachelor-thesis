...
Überschreiben einer weiteren Funktion beeinflusst werden. Dies ist insbesondere für die
\lstinline{ExclusivePopupWithButtons}-Klasse notwendig, da sie dem Dialog Buttons hinzufügen muss.

Aufgrund der einfachen Erweiterbarkeit der Dialog-Optionen besteht die
\lstinline{ExclusivePopupWithButtons}-Erweiterung der Dialogklasse primär aus Code, um das
Button-Array ist das vom Dialog-Widget benötige Format zu konvertieren.
