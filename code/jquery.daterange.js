(function($, undefined) {
  $.widget('cern.daterange', {
    ...
    _create: function() {
      ...
      self.element.addClass('ui-daterange')
        .append(self.container);

      // Create the date pickers
      // The picker options first get a default minDate, then the global picker options, then the picker-specific options, then our non-overridable options
